...
Subsequent work has produced a rich family of probabilistic data structures with improved space efficiency or additional functionality, but analyses typically treat each structure in isolation.
...
\Cref{sec:asets} introduces the Bernoulli set model and its axioms, including the higher-order composition theorem.
...
\Cref{sec:adt} formulates the Bernoulli set as an abstract data type with space complexity bounds.
\Cref{sec:entropy} derives the joint entropy of error counts.
