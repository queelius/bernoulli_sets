...
For instance, $\bigoplus = \cup$ with identity $\EmptySet$ computes the $n$-ary union of approximate sets, a construction that arises naturally in approximate Boolean search (see \cref{sec:bool_search}).
\end{remark}
