...
By the independence of errors across the two Bernoulli sets,
\begin{align}
...
The partition weights $w_1$, $w_2$, and $w_3$ are
operation-dependent: $w_1$ is the proportion exclusive
to $A_1$, $w_2$ is the proportion exclusive to $A_2$, and $w_3$
is the proportion in both.
See
\cref{eq:union_weights,eq:intersect_weights,eq:setdiff_weights}
...
by \cref{thm:closure_positive_intersect}.
