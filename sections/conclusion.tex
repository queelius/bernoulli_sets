...
At the per-element level, the Bernoulli set model reduces to a collection of independent binary symmetric channels~\cite{shannonBSC}, and the randomized-response mechanism of Warner~\cite{warner1965} provides a social-science interpretation.
